  ...
  return (
    <div className='card border border-c-light rounded-12 h-100'>
      <div className='card-body'>
        ...
        <div className='row g-3'>
          <div className='col-6'>
            <LabelValue labelWidth='col-6' valueWidth='col-10' />
          </div>
          <div className='col-6'>
            <LabelValue labelWidth='col-6' valueWidth='col-10' />
          </div>
          <div className='col-6'>
            <LabelValue labelWidth='col-3' valueWidth='col-7' />
          </div>
          <div className='col-6'>
            <LabelValue labelWidth='col-3' valueWidth='col-6' />
          </div>
          <div className='col-6'>
            <LabelValue labelWidth='col-3' valueWidth='col-6' />
          </div>
          <div className='col-6'>
            <LabelValue labelWidth='col-3' valueWidth='col-5' />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className='card border border-c-light rounded-12 h-100'>
      <div className='card-body'>
        ...
        <div className='row g-3'>
          <div className='col-12'>
            <LabelValue labelWidth='col-2' valueWidth='col-6' />
          </div>
          <div className='col-12'>
            <LabelValue labelWidth='col-4' valueWidth='col-5' />
          </div>
        </div>
      </div>
    </div>
      ...
      <div className='card-body'>
        ...
        <div className='row g-3'>
          <div className='col-12 col-md-4'>
            <LabelValue labelWidth='col-4' valueWidth='col-6' />
          </div>
          <div className='col-12 col-md-4'>
            <LabelValue labelWidth='col-4' valueWidth='col-5' />
          </div>
          <div className='col-12 col-md-4'>
            <LabelValue labelWidth='col-2' valueWidth='col-3' />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className='card border border-c-light rounded-12 h-100'>
      <div className='card-body'>
        ...
        <div className='row g-3'>
          <div className='col-12'>
            <LabelValue labelWidth='col-3' valueWidth='col-2' />
          </div>
          <div className='col-12'>
            <LabelValue labelWidth='col-3' valueWidth='col-2' />
          </div>
          <div className='col-12'>
            <LabelValue labelWidth='col-3' valueWidth='col-8' />
          </div>
        </div>
      </div>
    </div>
