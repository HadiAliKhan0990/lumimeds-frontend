...
import ProductIntakeResponsePopup from '../../popup/SingleFormResponse';
  ...
  const columns: Column<SurveySubmission>[] = [
      ...
      renderCell: (o) => {
        const displayName =
          o.submittedByType?.toLowerCase() === 'provider'
            ? formatProviderNameFromString(o.submittedByName)
            : o.submittedByName ?? 'N/A';

        return o.submittedByType?.toLowerCase() === 'patient' ||
          o.submittedByType?.toLowerCase() === 'provider' ||
    ...
    },
    {
      ...
      renderCell: (item) => (
        <button
          type='button'
          className='btn btn-link text-xs text-nowrap p-0'
          onClick={() => {
  ...
  return (
    <>
      ...
      <div className='row align-items-center mb-4'>
        <span className='text-lg fw-medium d-none d-lg-block col-lg-4'>Provider Intake</span>
