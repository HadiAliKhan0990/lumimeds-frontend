...
export interface BeakerPharmacyItemProps {
...
export const BeakerPharmacyItem = ({ products = [], drugForms, shippingServices, dosageData, quantitites, supplyDays }: BeakerPharmacyItemProps) => {
    const {
    PRODUCTS_OPTIONS,
    SHIPPING_OPTIONS,
    dosages,
  ...
  //         const { notes, clinicalDifferenceStatement } = notesPrepareHandler(strength ?? '', selectedProduct?.concentration ?? '', true);
