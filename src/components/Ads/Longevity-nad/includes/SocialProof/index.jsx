import FastShipping from '@/assets/ads/longevity-nad/fast-shipping.svg';
import LegitScript from '@/assets/ads/longevity-nad/Legitscript.svg';
import LicensedProviders from '@/assets/ads/longevity-nad/licensed-provider.svg';
...
export default function SocialProof() {
  return (
    <div>
      <section className='tw-px-5 tw-bg-[#D7E9FF] md:tw-py-[6.944vw] tw-py-16'>
