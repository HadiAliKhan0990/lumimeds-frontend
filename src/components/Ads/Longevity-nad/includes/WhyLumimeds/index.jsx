export default function WhyLumimeds() {
  return (
    <div className='tw-flex tw-flex-col tw-items-center tw-justify-center tw-px-5 tw-pb-0 lg:tw-max-w-[1640px] tw-mx-auto tw-w-full'>
      <div className='tw-max-w-[980px] tw-w-full tw-text-white'>
        <h2 className='tw-font-normal tw-font-lumitype lg:tw-text-[44px] md:tw-text-[32px] tw-text-[44px] md:tw-leading-[100%] tw-leading-[130%] tw-text-center'>
          Why Lumimeds for Longevity?
        </h2>
