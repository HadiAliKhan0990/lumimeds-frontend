  ...
  return (
    <>
      ...
      <div
        ...
        className='tw-relative tw-w-full tw-mx-auto tw-h-full tw-flex tw-flex-col tw-justify-center tw-items-center tw-gap-4 2xl:tw-gap-6 md:tw-my-20 tw-mt-10'
      >
        {isWidgetLoading && (
          <div className='tw-absolute tw-inset-0 tw-z-10 tw-flex tw-items-center tw-justify-center tw-bg-[#FCFAF7] tw-p-4'>
        ...
        >
          ...
          <div className='tw-w-full tw-h-full tw-flex tw-flex-col tw-justify-center tw-items-center tw-max-w-[360px] 2xl:tw-max-w-[612px]'>
            <div className='tw-w-full tw-flex tw-flex-col sm:tw-flex-row tw-justify-center tw-items-center tw-gap-5 2xl:tw-gap-6 tw-px-8'>
              ...
              <div className='tw-h-full tw-flex tw-flex-col tw-justify-center tw-items-center sm:tw-items-start'>
                ...
                <p className='tw-text-[#737373] tw-text-base tw-font-normal tw-leading-[120%] tw-font-Inter tw-whitespace-nowrap tw-mb-0'>
                  Journeys
                </p>
              </div>
            </div>
