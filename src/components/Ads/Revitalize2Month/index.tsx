...
import FeaturedProductSection from '@/components/Ads/Revitalize2Month/includes/FeaturedProduct';
import WhatIs503B from '@/components/Ads/Revitalize2Month/includes/WhatIs503B';
import Testimonials from '@/components/Home/Testimonials';
import ContactSection from '@/components/Ads/ContactSection';
import Revitalize1Contact from '@/assets/revitalize2-contact.png';
import '@/components/Ads/otp/style.scss';
import HeroBg from '@/assets/hero-revitalize2.png';
import '@/components/Ads/Revitalize2Month/style.scss';
...
export default function Revitalized2Month({ featuredProduct }: Readonly<Props>) {
  return (
    <>
      <section
