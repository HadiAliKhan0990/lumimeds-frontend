      ...
      <div className='md:tw-max-w-[1360px] tw-w-full tw-mx-auto md:tw-mt-16 tw-mt-8 md:tw-px-5'>
        ...
        <div className='tw-relative tw-block md:tw-hidden'>
          ...
          <button
            ...
            onClick={prevSlide}
            className='tw-absolute tw-top-[45%] tw-left-6 tw-w-[22px] tw-h-[29px] tw-flex tw-items-center tw-justify-center tw-p-0'
          >
            <span aria-hidden>
          ...
          <button
            ...
            onClick={nextSlide}
            className='tw-absolute tw-top-[45%] tw-right-6 tw-w-[22px] tw-h-[29px] tw-flex tw-items-center tw-justify-center tw-p-0'
          >
            <span aria-hidden>
