...
export default function MonthProduct({ totalPrice = 399, product: productData }: MonthProductProps) {
  ...
  const { renderTextWRTGoogleMerchant, isGoogleMerchant } = useGoogleMerchantConfig();
  ...
  const products: Product[] = useMemo(() => [
    {
      ...
      supplyLabel: isGoogleMerchant ? 'Once-A-Week Doses' : '3-Month Supply',
      ...
      features: [
        {
          icon: SupportIcon,
          title: isGoogleMerchant ? 'Optional Support' : 'Evaluation & Support',
          description: 'Initial evaluation & ongoing support',
        },
        {
          icon: DosingIcon,
          title: 'Starter Dosing',
          description: isGoogleMerchant ? 'Once-weekly doses of GLP-1/GIP' : 'All starter doses for the first 90 days',
        },
        {
          icon: DeliveryIcon,
        ...
        },
        {
          ...
          description: 'Access to patient support portal',
        },
      ],
    },
        ...
        <div key={product.id} className='tw-flex md:tw-flex-row tw-flex-col lg:tw-gap-16 md:tw-gap-10'>
          ...
          <div>
            ...
            >
              ...
              <span>{isTrySubdomain ? 'Add to Cart' : product.cta}</span>
            </button>
