import FastShipping from '@/assets/ads/longevity-microdosages/fast-shipping.svg';
import LegitScript from '@/assets/ads/longevity-microdosages/Legitscript.svg';
import LicensedProviders from '@/assets/ads/longevity-microdosages/licensed-provider.svg';
...
export default function SocialProof({ backgroundColor = '#EDF3FF' }: SocialProofProps) {
  return (
    <div>
      <section className={`tw-px-5 md:tw-py-[6.944vw] tw-py-16`} style={{ backgroundColor }}>
