...
export default function USFlag({ size, ...props }: Props) {
  return (
    <svg width={size} height={size} {...props} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 24'>
      <g fill='none'>
        <path fill='#f7fcff' fillRule='evenodd' d='M0 0h32v24H0z' clipRule='evenodd' />
        <path
          fill='#e31d1c'
          fillRule='evenodd'
