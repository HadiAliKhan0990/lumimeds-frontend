  ...
  return {
    ...
    robots:
      process.env.NEXT_PUBLIC_ALLOW_INDEXING === 'true'
        ...
        : 'noindex, nofollow',
    alternates: {
      canonical: 'https://www.lumimeds.com/dosing-guide/drug-crafters',
    },
    openGraph: {
      title: 'Tirzepatide Dosing Guide | Weekly & Monthly Instructions | Lumimeds',
      description:
        'Review weekly and monthly dosing instructions for compounded Tirzepatide. Follow provider-directed guidelines for safe, personalized weight-management treatment.',
      type: 'website',
      url: 'https://www.lumimeds.com/dosing-guide/drug-crafters',
    },
  };
}

export default function DrugCraftersPage() {
  return <PharmacyPage slug='drug-crafters' />;
}
