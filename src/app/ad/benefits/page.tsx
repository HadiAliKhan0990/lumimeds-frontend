...
import { hasAnyActiveProducts } from '@/lib/checkOlympiaProducts';
import Benefits from '@/components/Ads/Benefits';
...
export default async function BenefitsPage() {
  ...
  // If products are available, fetch all data and render the original benefits page
  ...
  if (!hasAnyActiveProducts(data)) {
    redirect('/');
  }

  // If products are available, render the original benefits page
  return <Benefits data={data} trustpilotData={trustpilotData} />;
}
