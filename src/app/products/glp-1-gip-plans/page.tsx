...
import { GLP1_GIP_ACCORDION } from '@/components/Products/Single/ConstantsSingle';
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'GLP-1/GIP Weight Loss Plans – Advanced Telehealth Treatments | LumiMeds',
    description:
      "Discover LumiMeds' GLP-1/GIP weight loss plans, offering advanced telehealth treatments with personalized support for your weight management journey.",
    robots:
      process.env.NEXT_PUBLIC_ALLOW_INDEXING === 'true'
        ? 'index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1'
        : 'noindex, nofollow',
    alternates: {
      canonical: 'https://www.lumimeds.com/products/glp-1-gip-plans',
    },
    openGraph: {
      title: 'GLP-1/GIP Weight Loss Plans – Advanced Telehealth Treatments | LumiMeds',
      description:
        "Discover LumiMeds' GLP-1/GIP weight loss plans, offering advanced telehealth treatments with personalized support for your weight management journey.",
      type: 'website',
      url: 'https://www.lumimeds.com/products/glp-1-gip-plans',
    },
  };
}

export default async function GLP1GIPPlansPage() {
  ...
  const product = products.glp_1_gip_plans;
  const accordionData = GLP1_GIP_ACCORDION;
  const accordionTitle = 'GLP-1/GIP Injections';
      ...
      <section className='pt-0' id='product-details'>
        <div id='sgltContent' className='row text-white pt-128'>
          ...
          <div className='col-12 col-lg-6 d-flex flex-column row-gap-24 bg-3060fe p-32'>
            <div>
              <h1 className='text-4xl fw-bold text-capitalize m-0'>
          ...
          <div className='row bg-3060fe-radius-24'>
            ...
            >
              <p className='font-weight-500' id='glp-1-subtext'>
                HOW DO GLP-1/GIP MEDICATIONS WORK?
              </p>
              <p className='font-weight-600' id='glp-1-title'>
                The science behind GLP-1 /GIP Medications
              </p>
              <p id='glp-1-description'>
                GLP-1/GIP medications mimic the GLP-1/GIP hormones the body produces immediately after food intake. When
                you eat, your digestive system releases this hormone to stimulate insulin production and balance blood
                sugar levels. GLP-1/GIP medications mirror the effects of the naturally occurring hormones, which also
                reduce appetite and promote feelings of fullness. These effects work together to help patients lose
                weight.
              </p>
            </div>
          </div>
